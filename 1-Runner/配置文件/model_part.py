'''
Author: loading-hh
Date: 2025-04-20 19:13:13
LastEditTime: 2025-05-06 21:58:26
LastEditors: loading-hh
Description: 
FilePath: \mm\1-Runner\配置文件\model_part.py
...
class Mlp(BaseModel):
    ...
    def loss(self, x, labels):
        return dict(loss = F.cross_entropy(x, labels))
...
def MyTrain():
    return torchvision.datasets.FashionMNIST(root="E:/BaiduNetdiskDownload/data", train=True, 
                                             transform = transforms.ToTensor(), download=True)

@DATASETS.register_module()
def MyTest():
    return torchvision.datasets.FashionMNIST(root="E:/BaiduNetdiskDownload/data", train=False, 
                                             transform = transforms.ToTensor(), download=True)
...
if __name__ == "__main__":
    config = Config.fromfile(r'E:\BaiduNetdiskDownload\mm\1-Runner\配置文件\config.py')
